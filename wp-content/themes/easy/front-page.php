<?php get_header(); ?>
    ...
    <div id="main">
        <!-- header -->
        <div id="header" style="background: url(<?php echo get_stylesheet_directory_uri() . '/html/images/1920x1080.jpg' ?>) no-repeat center; background-size: cover;">
            <!-- particles -->
                        ...
                        <div class="portfolio-block">
                            <ul class="work-list">
                                <li><a href="project.html">
                                        <img src="<?php echo get_stylesheet_directory_uri() . '/html/images/380x380.jpg' ?>" alt="">
